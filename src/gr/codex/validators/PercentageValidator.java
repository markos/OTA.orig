...
/* $Id: PercentageValidator.java 1514 2009-11-10 11:00:35Z markos $ */
...
public class PercentageValidator implements Validator {
	...
	public void validate(FacesContext context, UIComponent component, Object value) 
		...
		try {
			...
			System.out.println("PercentageValidator: value = " + n);
			if (n < 0.0 || n > 100.0) {
				throw new ValidatorException(new FacesMessage(component.getId() + ": Πρέπει να εισάγετε ένα ποσοστό (0-100%)!"));
			}
